                ...
                <div className="grid grid-cols-5 gap-1 pt-2">
                  {[7.83, 14.3, 20.8, 27.3, 33.8].map(hz => (
                    <button 
                      ...
                      className={`py-1.5 rounded-lg text-[8px] font-black tracking-tight transition-all border ${settings.schumann.frequency === hz ? 'bg-system-blue text-white border-system-blue' : 'bg-secondary-system-background text-system-secondary-label border-transparent'}`}
                    >
                      {hz}Hz
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {NATURE_SOUNDS.map(sound => (
                    <button 
                      ...
                      className={`py-2 px-1 rounded-xl text-[9px] font-bold uppercase transition-all border paper-button ${settings.nature.type === sound.id ? 'bg-system-green text-white border-system-green shadow-sm' : 'bg-secondary-system-background/50 border-apple-border text-system-secondary-label'}`}
                    >
                      {sound.name}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-4 gap-2">
                  {['none', 'white', 'pink', 'brown'].map(type => (
                    <button 
                      ...
                      className={`py-2 px-1 rounded-xl text-[9px] font-bold uppercase transition-all border paper-button ${settings.noise.type === type ? 'bg-system-orange text-white border-system-orange shadow-sm' : 'bg-secondary-system-background/50 border-apple-border text-system-secondary-label'}`}
                    >
                      {type === 'none' ? 'None' : type}
                    </button>
                  ))}
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {['soft', 'hard', 'loud', 'low'].map(p => (
                      <button 
                        ...
                        className={`py-2 px-1 rounded-xl text-[9px] font-bold uppercase transition-all border paper-button ${settings.mentalToughness.pitch === p ? 'bg-system-purple text-white border-system-purple shadow-sm' : 'bg-secondary-system-background/50 border-apple-border text-system-secondary-label'}`}
                      >
                        {p}
                      </button>
                    ))}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button 
                        ...
                        className={`py-2 px-1 rounded-xl text-[8px] font-bold uppercase transition-all border paper-button ${settings.mentalToughness.texture === t.id ? 'bg-system-purple text-white border-system-purple shadow-sm' : 'bg-secondary-system-background/50 border-apple-border text-system-secondary-label'}`}
                      >
                        {t.label}
                      </button>
                    ))}
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {['light', 'medium', 'strong', 'deep'].map(i => (
                      <button 
                        ...
                        className={`py-2 px-1 rounded-xl text-[9px] font-bold uppercase transition-all border paper-button ${settings.mentalToughness.intensity === i ? 'bg-system-purple text-white border-system-purple shadow-sm' : 'bg-secondary-system-background/50 border-apple-border text-system-secondary-label'}`}
                      >
                        {i}
                      </button>
                    ))}
